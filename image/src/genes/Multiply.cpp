...
void ci::MultiplyGene::initializeParametersFromConfig(
        const std::unordered_map<std::string, std::string>& geneParameters) {
    // Nothing to initialize!
}

void ci::MultiplyGene::initializeParametersFromTemplateGene(const cc::Gene* other) {
    // Nothing to initialize!
}

void ci::MultiplyGene::mutateParameters() {
    // Nothing to mutate!
}

void ci::MultiplyGene::evaluate(std::vector<std::shared_ptr<cc::DataChunk>>& buffers) {
...
std::string ci::MultiplyGene::generateCode(cc::CodeGenerationContext_t& context) const {
...
std::unordered_map<std::string, std::string> ci::MultiplyGene::serializeInternal() const {
