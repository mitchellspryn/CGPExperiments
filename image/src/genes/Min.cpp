...
void ci::MinGene::initializeParametersFromConfig(
        const std::unordered_map<std::string, std::string>& geneParameters) {
    // Nothing to initialize!
}

void ci::MinGene::initializeParametersFromTemplateGene(const cc::Gene* other) {
    // Nothing to initialize!
}

void ci::MinGene::mutateParameters() {
    // Nothing to mutate!
}

void ci::MinGene::evaluate(std::vector<std::shared_ptr<cc::DataChunk>>& buffers) {
...
std::string ci::MinGene::generateCode(cc::CodeGenerationContext_t& context) const {
...
std::unordered_map<std::string, std::string> ci::MinGene::serializeInternal() const {
