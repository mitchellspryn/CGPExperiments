...
static constexpr int kAverageGeneTypeId = 3;
static constexpr const char* kAverageGeneTypeName = "average";

// Computes the pixel-wise average of two images
class AverageGene : public cgpExperiments::core::Gene {
    public:
        virtual ~AverageGene() {};
        virtual int getTypeId() const override { return kAverageGeneTypeId; }
        ...
        virtual std::string getGeneName() const override { return std::string(kAverageGeneTypeName); }
        ...
        virtual float getComputeCost() const override { return 496.0f; }
