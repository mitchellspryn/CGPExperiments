...
static constexpr int kDilateGeneTypeId = 6;
static constexpr const char* kDilateGeneTypeName = "dilate";

// Runs the dilation operator
class DilateGene : public cgpExperiments::core::Gene {
    public:
        virtual ~DilateGene() {};
        virtual int getTypeId() const override { return kDilateGeneTypeId; }
        ...
        virtual std::string getGeneName() const override { return std::string(kDilateGeneTypeName); }
        ...
        virtual float getComputeCost() const override { return 525.0f; }
